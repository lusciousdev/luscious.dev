# Generated by Django 4.2.9 on 2024-02-24 06:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timer_start', models.BigIntegerField(default=1708757412)),
                ('paused', models.BooleanField(default=False)),
                ('pause_time', models.BigIntegerField(default=1708757412)),
                ('overlay', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='overlay.collaborativeoverlay')),
            ],
            options={
                'abstract': False,
