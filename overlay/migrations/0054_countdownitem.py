# Generated by Django 5.2.1 on 2025-06-14 20:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('overlay', '0053_overlayuserinfo_embed_stream_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='My Countdown', max_length=256)),
                ('timer_format', models.TextField(default='{0}')),
                ('timer_end', models.BigIntegerField(default=lusciousdev.util.modelutil.current_time_seconds)),
